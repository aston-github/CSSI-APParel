...
def seed_data():
    ...
    item1 = Item(img_url = 'https://di2ponv0v5otw.cloudfront.net/posts/2019/05/01/5cc992fb689ebcecea8359c7/m_5cc9930c7f617f8c7af77091.jpg', description = 'Adidas Track Pants, Size: Medium', owner = EDIT)
    item2 = Item(img_url = 'http://images.backstreetmerch.com/images/products/bands/clothing/quee/bsi_quee181.jpg', description = 'Queen T-Shirt, Size: Large', owner = EDIT)
    item3 = Item(img_url = 'https://dtpmhvbsmffsz.cloudfront.net/posts/2017/12/09/5a2c3857f0137d5191019f24/m_5a2c3931291a3528c701af41.jpg', description = 'Silver Necklace', owner = EDIT)
